      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <p className="text-base sm:text-lg text-slate-600">
            Have questions or looking for advice on your website architecture? Send us a message and our team will get back to you promptly.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="rounded-3xl bg-white border border-slate-200/90 p-8 shadow-card space-y-6">
              ...
              <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">
                Reach out directly via email, phone, or visit our office. We look forward to collaborating.
              </p>
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <div className="text-xs font-bold uppercase tracking-wider text-slate-400">Direct Line</div>
              ...
              {isSuccess ? (
                <div className="py-12 text-center space-y-4 animate-in zoom-in-95 duration-200">
                  ...
                  <p className="text-sm text-slate-600 max-w-md mx-auto">
                    Your enquiry has been received and logged in our system. A senior team member from NSK will connect with you within 24 hours.
                  </p>
                  <button
